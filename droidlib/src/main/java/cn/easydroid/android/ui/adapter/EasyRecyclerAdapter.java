...
public abstract class EasyRecyclerAdapter<T, F extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<F> {
     ...
     * @param position
     */
    protected void adjustMargin(View itemView, int position) {
        HeaderFooterMargin.adjustDefault(itemView,getItemCount(),position);
    }
    ...
    public void addData(List<T> data) {
        ...
        if (data != null && data.size() > 0) {
            ...
            if (preSize > 0) {
                notifyItemRangeChanged(preSize - 1, this.data.size());
            } else {
                notifyItemRangeChanged(preSize, this.data.size());
            }
//            notifyDataSetChanged();
        }
//        notifyDataSetChanged();
